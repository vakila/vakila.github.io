...
<div style="width:100%; display:flex; display:-webkit-flex; flex-flow: column; justify-content:space-around; ">

<div style="display:flex; display:-webkit-flex;">
<div style="margin:5px; flex-shrink:0; flex-grow:1; display:flex; display:-webkit-flex; flex-flow:column; justify-content:flex-start;">
HTML:
<div style="flex-grow:1; background-color:#f9f9f9;">
{% highlight HTML %}
<div id="parent">
    <div>A</div>
    <div>B</div>
...
<div style="display:flex; display:-webkit-flex; flex-flow:column; justify-content:flex-start; flex-shrink: 2;  margin:5px; width:40%;">
Result:
<div id="parent" style="padding:10px; border:2px solid black; text-align:center; flex-grow:1;">
    <div>A</div>
    <div>B</div>
    <div>C</div>
    <div>D</div>
...
<div style="display:flex; display:-webkit-flex;">
<div style="margin:5px; flex-shrink:0; flex-grow:1;">
CSS:
{% highlight CSS %}
#parent {
  width: 40%;
...
<div style="display:flex; display:-webkit-flex; flex-flow:column; justify-content:flex-start; flex-shrink: 2;  margin:5px; width:40%;">
Result:
<div id="parent" style="display:flex; display:-webkit-flex; flex-flow:row wrap; align-items:center; align-content:space-between; justify-content:center; padding:10px; border:2px solid black; flex-grow:1;">
...
<div style="width:100%; display:flex; display:-webkit-flex; flex-flow:row;">
...
<div style="display:flex; display:-webkit-flex; flex-direction:column; margin:5px; width:40%; flex-shrink:2;">
Result:
<div id="parent" style="height:150px; display:flex; display:-webkit-flex; flex-flow:column wrap; align-items:center; align-content: space-between; justify-content:center; padding:10px; border:2px solid black; flex-grow:1;">
    <div class="child">A</div>
    <div class="child">B</div>
    <div class="child">C</div>
    <div class="child">D</div>
...
<div style="display:flex; display:-webkit-flex; flex-flow:column; justify-content:flex-start; flex-shrink: 2;  margin:5px; width:40%;">
Result:
<div id="parent" style="display:flex; display:-webkit-flex; flex-flow:row-reverse wrap; align-items:center; align-content:space-between; justify-content:center; padding:10px; border:2px solid black; flex-grow:1;">
    <style>.child {width: 25%; padding:.5em 0; text-align:center;}</style>
    <div class="child">A</div>
    <div class="child">B</div>
    <div class="child">C</div>
...
<div style="display:flex; display:-webkit-flex; flex-flow:column; justify-content:flex-start; flex-shrink: 2;  margin:5px; width:40%;">
Result:
<div id="parent" style="display:flex; display:-webkit-flex; flex-flow:row-reverse wrap-reverse; align-items:center; align-content:space-between; justify-content:center; padding:10px; border:2px solid black; flex-grow:1;">
    <style>.child {width: 25%; padding:.5em 0; text-align:center;}</style>
    <div class="child">A</div>
    <div class="child">B</div>
    <div class="child">C</div>
...
<div style="width:100%; display:flex; display:-webkit-flex; justify-content:flex-start; ">
...
<div style="display:flex; display:-webkit-flex; flex-direction:column; margin:5px; flex-grow:1; flex-shrink:2;">
Result:
<div id="parent" style="display:flex; display:-webkit-flex; flex-direction:column; align-items:center; justify-content:center; padding:10px; border:2px solid black; flex-grow:1;">
    <div id="A">A</div>
    <div id="B" style="order:1;">B</div>
    <div id="C">C</div>
    <div id="D" style="order:-1;">D</div>
</div>
</div>
</div>
