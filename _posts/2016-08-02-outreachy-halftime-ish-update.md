...
* **The tools**
  ...
  Then, since the project I'm working focuses on testing, I had to grok tools like [Pytest](http://docs.pytest.org/en/latest/) and [Mock](https://docs.python.org/3/library/unittest.mock.html). Since most everything I'm doing is in Python, I've also been picking up useful Python tidbits here and there.
